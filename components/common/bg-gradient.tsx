...
export default function BgGradient({
  ...
  return (
    <div className={`relative isolate ${className}`}>
      <div
        aria-hidden="true"
        className="absolute-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-30"
      >
        <div
            style={{
            clipPath:
              'polygon(50% 0% 6% 35% 98% 35% 68% 57% 79% 91% 50% 70% 21% 91% 32% 57% 2% 35% 39% 35%)',
          }}
