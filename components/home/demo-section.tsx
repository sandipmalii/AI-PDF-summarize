...
>
  <div 
    ...
    style={{
      clipPath: 'polygon(74.16% 44.1%, 100% 61.6%, 97.58% 26.9%, 85.5% 80.7%, 2% 72.5%, 32.5% 60.2%, 62.4% 52.4%, 68.18% 47.5%, 58.3% 45.2%, 34.5% 27.5%, 76.7% 0.19%, 64.9% 17%, 100% 27.69%, 76.8% 76.1%, 97.7% 74.1%, 44.1%)',
    }}
  />
</div>
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="font-bold text-3xl max-w-2xl mx-auto px-4 sm:px-6">
            <div className="inline-flex items-center justify-center p-2 rounded-2xl bg-gray-100/80 backdrop-blur-xs border border-gray-500/20 mb-4"> 
              <Pizza className="mx-auto h-16 w-6 text-rose-500" />
            </div>
            
            {/* Heading */}
            <div className="text-center mb-16">
              <h3 className="font-bold text-3xl max-w-2xl mx-auto px-4 sm:px-6">
                Watch How PDFSummize transforms{' '} 
              ...
              {/* Placeholder for Summary Viewer */}
            </div>
          </div>
        </div> 
      </div>
